...
const DeleteAccount = ( {auth} ) => {
    ...
    return (
        <Box mt={12}>
            <Text fontSize="lg" color="#3D3D3D" fontWeight="bold">Datos</Text>
            <Flex alignItems="center" gap={6} mt={6}>
                ...
                <Text fontSize="lg" color="#6C6C6C" fontWeight="bold">Borrar Historial</Text>
            </Flex>
            <ConfirmDialog
            ...
            >
                <Flex alignItems="center" gap={6} mt={6}>
                    ...
                    <Text fontSize="lg" color="#6C6C6C" fontWeight="bold">Eliminar Cuenta</Text>
                </Flex>
            </ConfirmDialog>
        </Box>
    );
